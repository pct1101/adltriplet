...
function AdminDriverLicenseDetails() {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f4f4f4', minHeight: '100vh' }}>
            <Side_bar />
            <div className="main-wrapper section" style={{ marginLeft: '250px', padding: '20px' }}>
                <Header />
                <h1 className="title" style={{ fontSize: '24px', marginBottom: '20px', color: '#333' }}>
                    Chi tiết Giấy phép Lái xe
                </h1>
                <div className="container-m" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
                    {driverLicense ? (
                        <form onSubmit={handleSubmit}>
                            <div className="row" style={{ display: 'flex', flexWrap: 'wrap' }}>
                                {/* Cột bên trái: Thông tin giấy phép */}
                                <div className="col-md-6" style={{ marginBottom: '20px' }}>
                                    <h3 style={{ color: '#2d2d2d', marginBottom: '10px' }}>Thông tin Giấy phép Lái xe</h3>
                            ...
                            <div style={{ textAlign: 'center' }}>
                                {isEditing ? (
                                    <button type="submit" className="btn btn-primary" style={{ padding: '10px 20px', borderRadius: '5px', backgroundColor: '#007bff', color: 'white', border: 'none' }}>
                                        Lưu thay đổi
                                    </button>
                                ) : (
                                    <button type="button" className="btn btn-secondary" style={{ padding: '10px 20px', borderRadius: '5px', backgroundColor: '#6c757d', color: 'white', border: 'none' }} onClick={() => setIsEditing(true)}>
                                        Chỉnh sửa
                                    </button>
                                )}
                            </div>
